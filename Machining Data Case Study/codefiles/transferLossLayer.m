...
%%
classdef transferLossLayer < nnet.layer.RegressionLayer
    properties
        Weights
        LossFunction
        LayerGraph
    ...
    methods
        function layer = transferLossLayer(name, lossType, netArray, sourceData, targetData,hiddenLayers, weights)
...
%         end
        ...
        function loss = forwardLoss(layer, Y, T)
            ...
            if wnmmd > 0
                ...
                sourceFeatures = extractDLarrayFeatures(dlnet,)
                
                [mmd,~] = mmdLoss(sourceFeatures,targetFeatures,N,dlnet,hiddenLayers);
            else
                mmd = 0;
            end
...
%       Compute Backward Loss of MSE-MMD
        function dLdY = backwardLoss(layer, Y, T)
            ...
            if wnmmd > 0
                sourceData = layer.SourceData(1:N,1);
                targetData = layer.TargetData(1:N,1);
            [~,gradMMD] = mmdLoss(sourceData,targetData,N,layer.LayerGraph,layer.FeatureOutputs);
